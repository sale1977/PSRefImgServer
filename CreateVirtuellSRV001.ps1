...
$VMName = "SRV01"
$VMLocation = "C:\VM"
$ISOFile = "C:\Users\scharmer\Desktop\Windows2016Build729.iso"
...
New-VM -Name $VMName -Generation 2  -NewVHDPath "$VMLocation\$VMName.vhdx" -NewVHDSizeBytes 40GB | Set-VM -StaticMemory -MemoryStartupBytes 2048MB -ProcessorCount 2 -AutomaticStartAction Nothing
